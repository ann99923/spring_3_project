...
public class CosmeticsController {
	...
	public String searchProdGET(CateCriteria ccri, Model model) {

		logger.info("cri : " + ccri);

		List<CosmeticsVO> list = cosService.getProdList(ccri);
		...
		model.addAttribute("pageMaker", new PageDTO(ccri, cosService.prodGetTotal(ccri)));
