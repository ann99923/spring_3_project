...
public class PageMakerUserDTO {
   ...
   private CriteriaUser cri;

   public PageMakerUserDTO(CriteriaUser cri, int total) {
      super();
      this.cri = cri;
      this.total = total;
   ...
   public CriteriaUser getCri() {
      return cri;
   }

   public void setCri(CriteriaUser cri) {
      this.cri = cri;
   }
