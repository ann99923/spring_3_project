...
<body>
	...
	<div class="input_wrap">
		<label>이 미 지 파 일</label><br>		
			<img src="/resources/image/${pageInfo.img1}" style="width: 100px; height: 75px;">
			<img src="/resources/image/${pageInfo.img2}" style="width: 100px; height: 75px;">
			<img src="/resources/image/${pageInfo.img3}" style="width: 100px; height: 75px;"><br>
			<!-- 	
	...
	<form id="infoForm" method="get" action="/admin/list">
	...
	<script>	
      ...
      $("#main_btn").on("click", function(e) {
         ...
         form.attr("action", "/admin/list");
         form.submit();
      });
      $("#update_btn").on("click", function(e) {
         form.attr("action", "/admin/update");
         form.submit();
      });
   </script>
</body>
